        ...
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-turquoise-100">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">{email ?? "Loading…"}</p>
              </div>
            </div>
          </div>
            ...
            {!showConfirm ? (
              ...
              <div className="mt-4 space-y-3 rounded-xl border border-red-100 bg-red-50/50 p-4">
                ...
                <input
                  ...
                  placeholder="DELETE"
                  className="w-full max-w-xs rounded-xl border border-neutral-200 bg-white px-4 py-2.5 text-sm text-neutral-900 placeholder:text-neutral-400 focus:border-red-400 focus:outline-none focus:ring-2 focus:ring-red-100"
                />
                <div className="flex gap-3">
                  <button
                    ...
                    disabled={deleting}
                    className="rounded-xl border border-neutral-200 bg-white px-5 py-2.5 text-sm font-medium text-neutral-700 shadow-sm transition hover:bg-neutral-50 disabled:opacity-50"
                  >
                    Cancel
                  </button>
                  <button
