...
| P2 | **PostHog / milestones** (when ready) | Measure drop-off per step — see `docs/operations.md` for ops. | Done — PostHog browser + server events (PR #4); set `NEXT_PUBLIC_POSTHOG_*` in Vercel. |
